...
export function UserMini({ className }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20"
...
export function Eye({ className, onClick }) {
  return (
    <svg
      onClick={onClick}
      xmlns="http://www.w3.org/2000/svg"
...
export function EyeSlash({ className, onClick }) {
  return (
    <svg
      onClick={onClick}
      xmlns="http://www.w3.org/2000/svg"
...
export function Spinner({
  ...
  return (
    <div className="flex grow">
      <div role="status" className={className ? className : "my-auto mx-auto"}>
        <svg
          aria-hidden="true"
          className={`inline ${size} mr-2 ${secondaryColor} animate-spin dark:${secondaryDarkColor} ${primaryColor}`}
          viewBox="0 0 100 101"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
