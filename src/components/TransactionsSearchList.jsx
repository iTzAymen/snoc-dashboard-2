    ...
    <div className={className + " overflow-hidden py-3"}>
      <div className="flex flex-col justify-between gap-2">
        <div className="flex w-full justify-between px-2">
          ...
          <h1 className="font-bold w-1/6 text-center capitalize truncate">
            Transaction ID
          </h1>
          <p className="font-bold w-1/6 text-center capitalize truncate">
            Pos ID
          </p>
          <p className="font-bold w-1/6 text-center capitalize truncate">
            Type
          ...
          <p className="font-bold w-5 md:w-1/6  text-right capitalize truncate">
            Status
          </p>
        </div>
        {data.map((transaction_data, pdv_index) => (
          ...
          >
            ...
            <h1 className=" w-1/5 text-center capitalize">
              {transaction_data.id}
            </h1>
            <p className=" w-1/5 text-center capitalize">
              {transaction_data.posid}
            </p>
            <p className=" w-1/5 text-center capitalize truncate">
              {transaction_data.type}
            </p>
            <p className=" w-1/5 text-center capitalize truncate">
              {transaction_data.date}
            </p>
            <div className="w-5 md:w-1/6 text-right capitalize flex justify-end">
