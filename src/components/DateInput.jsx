  ...
  return (
    <div className="inline-block">
      <DropDown
        ...
        className="bg-zinc-800 w-20 hover:bg-zinc-850 border-zinc-600 border border-r-0 px-2 py-2 rounded-l-lg"
      />
      <DropDown
        updateDate={updateDate}
        label="Month"
        ...
        className="bg-zinc-800 w-24 hover:bg-zinc-850 border-zinc-600 border px-2 py-2"
      />
      <DropDown
        updateDate={updateDate}
        label="Year"
        ...
        className="bg-zinc-800 w-24 hover:bg-zinc-850 border-zinc-600 border border-l-0 px-2 py-2 rounded-r-lg"
      />
    </div>
  );
}
